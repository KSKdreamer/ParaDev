# API Section Line Guards Progress

Date: 2026-06-16 11:43 CST

Linear: N/A

## Done

- Hardened `api_section_lines` so scalar section collections and scalar section-line groups fail with contextual `TypeError` messages instead of being iterated as characters.
- Added regression tests for both invalid section shapes while preserving existing valid Markdown assembly behavior.
...
- Continue tightening API reference helper input validation in small slices.
