# Frontend API Option Source Provider ID Helper

Date: 2026-06-14 17:52 Asia/Shanghai

## Summary

- Added `_frontend_api_option_source_operation_id` for option-source provider operation ids.
- Routed option-source summary, required/alias summary, option-source index, and provider index rows through the helper.
...
- This is a behavior-preserving maintainability slice scoped to frontend API option-source provider rendering.
