# Frontend API Field Option Source Helper

Date: 2026-06-14 17:55 Asia/Shanghai

## Summary

- Added `_frontend_api_field_option_source` for frontend API table renderers that need a mapping-valued field option source.
- Routed option-source summary, required/alias summary, option-source index, provider index, and provider cell rendering through the helper.
