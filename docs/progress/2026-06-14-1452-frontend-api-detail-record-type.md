# Frontend API Detail Record Type Progress
...
- Added a private `_FrontendApiDetailRecord` alias for shared detail-table records.
- Replaced duplicated action-execution, confirmation, and option-source record tuple annotations while preserving runtime behavior and markdown output.
...
- Continue reducing duplicated internal table contracts in `src/paradev/sdk/frontend_api.py` without changing generated API output.
