# API Markdown Index Spec Helper Progress

Date: 2026-06-16 17:24

Linear: N/A

## Done

- Extracted API Markdown index-section spec validation into `_api_markdown_index_section_spec`.
- Kept `api_index_sections` behavior, generated reference output, and validation messages unchanged.
...
- Continue small API helper cleanup while the committed SDK/CLI/REST/MCP reference catalog remains stable.
