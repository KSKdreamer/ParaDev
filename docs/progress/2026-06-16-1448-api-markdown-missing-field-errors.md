# API Markdown Missing Field Errors

## Done

- Added contextual missing-field errors for generated API Markdown row rendering.
- Added contextual missing-index errors for named generated API Markdown table indexes.
- Added regression coverage for missing selected row fields and missing named table indexes.
...
- Continue tightening generated API reference contracts and diagnostics for the documented SDK, CLI, REST, MCP, and GUI surfaces.
