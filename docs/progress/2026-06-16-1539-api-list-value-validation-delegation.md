# API List Value Validation Delegation Progress

Date: 2026-06-16 15:39

Linear: N/A

## Done

- Delegated API table row-field list-value validation to the shared `_api_list_items` helper.
- Updated private guard helper annotations to accept `object`, matching their runtime validation role for untrusted API table inputs.
...
- Continue simplifying shared API table and Markdown table helpers while keeping generated SDK, CLI, REST, and MCP reference outputs stable.
