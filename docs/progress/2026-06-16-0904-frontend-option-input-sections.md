# 2026-06-16 09:04 Frontend Option Input Section Helpers

## Scope

- Continued behavior-preserving modularization in `src/paradev/sdk/frontend_api.py`.
- Extracted reusable table-section wrappers for option-source detail rows, option-provider rows, and input-field rows.
