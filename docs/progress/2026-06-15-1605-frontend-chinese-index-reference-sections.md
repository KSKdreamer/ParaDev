# Frontend Chinese Index Reference Sections

Date: 2026-06-15 16:05

## Scope

- Continued the generated frontend API reference renderer cleanup in `src/paradev/sdk/frontend_api.py`.
- Routed the Chinese mirror's index catalog, group/status/mode/surface indexes, surface coverage, and REST route sections through the shared API table-section helper.
