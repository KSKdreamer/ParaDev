# Frontend API Option Source Context Helper

Date: 2026-06-14 18:05 Asia/Shanghai

## Summary

- Added `_frontend_api_option_source_requires` and `_frontend_api_option_source_forward` for option-source context fields.
- Routed option-source summary, option-source detail, and provider index rows through the helpers.
