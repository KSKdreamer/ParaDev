# Frontend API Action Group Records Progress

Date: 2026-06-14 15:12
...
- Added `_FrontendApiActionGroupMap` and `_FrontendApiWorkspaceActionGroups` aliases for the group action summary helper.
- Replaced the raw nested workspace-action grouping tuple annotation without changing group rows, operation rows, action grouping, or generated reference output.
