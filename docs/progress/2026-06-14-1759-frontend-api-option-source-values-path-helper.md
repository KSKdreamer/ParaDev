# Frontend API Option Source Values Path Helper

Date: 2026-06-14 17:59 Asia/Shanghai

## Summary

- Added `_frontend_api_option_source_values_path` for option-source `values_path` rendering.
- Routed option-source summary, option-source index, and provider index rows through the helper.
