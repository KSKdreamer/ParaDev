# Frontend API Callback Contracts Progress

Date: 2026-06-14 15:27
...
- Added private callback aliases for static summary cells, owner summary/detail/action cells, input cells, and input predicates.
- Replaced repeated long `Callable[...]` annotations in the API table renderer without changing table rows, row ordering, or generated reference output.
