# API List Parameter Mapping Guard Progress

Date: 2026-06-16 13:06

Linear: n/a

## Done

- Added an explicit mapping guard for API table list-like parameters.
- Covered index field sets, list-field sets, skip-empty sets, row field selection, top-level index specs, and individual index specs.
- Preserved valid tuple/list/generator input behavior while preventing dictionaries from being interpreted as key lists.
...
- Continue tightening generated API table contracts around explicit validation and generated-reference parity.
