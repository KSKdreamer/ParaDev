# API Markdown String-Key Helper Progress
...
- Consolidated API Markdown table and row string-key mapping validation behind one private helper.
- Preserved existing validation behavior and error labels for table, row, and generated-reference callers.
...
- Full suite deferred to keep CPU free while PIHC3 migration work continues.
- Unrelated dirty skill, desktop, PIHC3, loader, and local asset changes were left untouched.

## Next

- Continue reducing API Markdown helper duplication while keeping generated SDK, CLI, REST, and MCP reference outputs stable.
