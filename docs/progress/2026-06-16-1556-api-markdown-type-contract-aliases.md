# API Markdown Type Contract Aliases Progress

Date: 2026-06-16 15:56

Linear: N/A

## Done

- Added focused aliases for API Markdown records, row collections, and index mappings.
- Updated generated-reference Markdown helper signatures and casts to use those aliases, keeping SDK, CLI, REST, and MCP reference contracts easier to scan.
...
- Continue clarifying API table data and Markdown renderer contracts while keeping generated-reference output stable.
