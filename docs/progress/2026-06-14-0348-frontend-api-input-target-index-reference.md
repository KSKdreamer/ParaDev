# Frontend API Input Target Index Reference Progress

Date: 2026-06-14 03:48 +0800

Linear: none

## Done

- Added generated Input Target Index tables to the frontend API reference renderer.
- The new table lists every declared input field with its normalizer target bucket, operation id, adapter-side alias, type, and required state.
- Regenerated `docs/user-manual/frontend-api-reference.md`.
- Updated the frontend API guide to mention the input-target routing audit table.
- Added targeted architecture and CLI assertions for project, parameters, selectors, projections, and alias routing rows.
