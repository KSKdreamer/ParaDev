# Frontend API Operation ID Detail Row Progress

Date: 2026-06-14 11:13

Linear: N/A

## Done

- Extracted shared operation-id detail row rendering for group, REST route, and binding index tables.
- Preserved existing prefix-cell rendering and operation-id count/list columns.
