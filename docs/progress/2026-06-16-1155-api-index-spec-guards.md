# API Index Spec Guards Progress

Date: 2026-06-16 11:55 CST

Linear: N/A

## Done

- Hardened API indexed-table construction so malformed index spec collections fail with contextual errors before duplicate-index checks.
- Added regression tests for scalar index collections, scalar index specs, and wrong-length index specs while preserving valid named-index generation behavior.
