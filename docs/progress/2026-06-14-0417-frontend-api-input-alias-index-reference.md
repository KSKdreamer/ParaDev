# Frontend API Input Alias Index Progress

Date: 2026-06-14 04:17 +0800

Linear: none

## Done

- Added generated Input Alias Index tables to the frontend API reference renderer.
- The new table lists only fields with frontend-to-adapter aliases, including operation id, type, normalizer target bucket, `maps_to`, required state, and option-source provider.
- Regenerated `docs/user-manual/frontend-api-reference.md`.
- Updated the frontend API guide to mention the alias-only audit table.
- Added targeted architecture and CLI assertions for source-text, draft, and artifact alias rows.
