# 2026-06-15 11:53 API symbol header helper

## Scope

- Added a shared `api_symbol_table_header()` helper for generated API-standard Markdown tables.
- Reused it across public facade/API reference renderers that emit the common 12-column symbol table.
