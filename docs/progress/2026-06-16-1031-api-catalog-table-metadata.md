# API Catalog Table Metadata Progress

Date: 2026-06-16 10:31 CST

Linear: N/A

## Done

- Promoted API catalog table index specs, index list fields, row list fields, reference list fields, and markdown fields into named constants.
- Kept the aggregate API catalog payload, reference grouping, row order, and generated Markdown unchanged.
...
- `rtk git diff --check -- src/paradev/surfaces/api_catalog.py docs/progress/2026-06-16-1031-api-catalog-table-metadata.md`
...
- Continue making API table renderer metadata explicit and reusable while preserving public SDK, CLI, REST, MCP, and documentation contracts.
